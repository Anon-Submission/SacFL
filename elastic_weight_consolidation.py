...
class ElasticWeightConsolidation:
    ...
    def _update_fisher_params(self, args, current_ds, batch_size, num_batch):
        dl = current_ds
        log_liklihoods = []
        for i, (input, target) in enumerate(dl):
            ...
            if 'text' in args.model_name.lower():
                input = input.long()
            else:
    ...
    def register_ewc_params(self, args, dataset, batch_size, num_batches):
        self._update_fisher_params(args, dataset, batch_size, num_batches)
